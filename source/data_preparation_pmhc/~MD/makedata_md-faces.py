...
precomputed_pdbs = glob.glob(
    os.path.join(params["masif_precomputation_dir_md"], "10_7", "*", "p1_X.npy")
...
datalist_dir = params["datalist_md-faces"]
...
success = 0
## 这里需要改动：对应/MD/子文件夹 (已经创建过)
precom_dir = params["masif_precomputation_dir_md"]
tcr_coord_dir = params["tcr_coords_dir_md"]

tfrecords_dir = params["tfrecords_md-faces"]
