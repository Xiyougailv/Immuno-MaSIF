...
datalist_dir = params["datalist_zero-shot"]
...
np.save(os.path.join(datalist_dir, "1_train_pdbs_pmhc.npy"), train1)
np.save(os.path.join(datalist_dir, "1_test_pdbs_pmhc.npy"), test1)
np.save(os.path.join(datalist_dir, "2_train_pdbs_pmhc.npy"), train2)
np.save(os.path.join(datalist_dir, "2_test_pdbs_pmhc.npy"), test2)
np.save(os.path.join(datalist_dir, "3_train_pdbs_pmhc.npy"), train3)
np.save(os.path.join(datalist_dir, "3_test_pdbs_pmhc.npy"), test3)
np.save(os.path.join(datalist_dir, "4_train_pdbs_pmhc.npy"), train4)
np.save(os.path.join(datalist_dir, "4_test_pdbs_pmhc.npy"), test4)
...
tfrecords_dir = params["tfrecords_zero-shot"]
...
with tf.compat.v1.python_io.TFRecordWriter(
    os.path.join(tfrecords_dir, f"{gamenum}_training_data_17.tfrecord")
) as writer:
...
success = 0
with tf.compat.v1.python_io.TFRecordWriter(
    os.path.join(tfrecords_dir, f"{gamenum}_testing_data_3.tfrecord")
) as writer:
