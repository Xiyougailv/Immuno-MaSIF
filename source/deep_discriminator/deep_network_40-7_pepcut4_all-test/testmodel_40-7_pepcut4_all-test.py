...
testing_data = tf.data.TFRecordDataset(
    os.path.join(params["tfrecords_40-7_pepcut4_all-test"], f"{gamenum}_testing_data_13.tfrecord")
)
testing_data = testing_data.map(_parse_function)

model_dir = params["model_40-7_pepcut4_all-test"]
output_model = model_dir + f"{gamenum}_model"


test_set_out_dir = params["predict_40-7_pepcut4_all-test"]
...
with tf.Session() as sess:
    ...
    num_test_samples = 13 ## 注意修改，12.07
